...
INSERT INTO "new_Ward" ("createdAt", "dayShiftRatio", "eveningShiftRatio", "id", "minNursesDay", "minNursesEvening", "minNursesNight", "name", "nightShiftRatio", "nursePatientRatio", "totalBeds", "updatedAt") SELECT "createdAt", "dayShiftRatio", "eveningShiftRatio", "id", "minNursesDay", "minNursesEvening", "minNursesNight", "name", "nightShiftRatio", "nursePatientRatio", "totalBeds", "updatedAt" FROM "Ward";
DROP TABLE "Ward";
